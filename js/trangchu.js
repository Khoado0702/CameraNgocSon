window.onload = function () {
	...
	var tags = ["KBvision", "HIKvision", "Dahua", "Questek", "Ezviz"];
	for (var t of tags) addTags(t, "index.html?search=" + t);

	// Thêm danh sách hãng điện thoại
	var company = ["KBVISION.jpg", "HIKVISION.jpg", "DAHUA.jpg", "Questek.jpg", "Ezviz.jpg", "NetCAM.png",
		"YooSee.png", "KBONE.jpg", "Tapo.jpg", "Imou.jpg", "Vantech.jpg", "Afiri.jpg",
		"Ebitcam.png", "Panasonic.jpg", "Lilin.jpg"
	];
